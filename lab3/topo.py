...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        self.addLink( s1 , s9, bw=10, delay='20ms')
        self.addLink( s2 , s3, bw=10, delay='16ms')
        self.addLink( s2 , s4, bw=10, delay='40ms')
        self.addLink( s3 , s4, bw=10, delay='14ms')
        self.addLink( s4 , s5, bw=10, delay='55ms')
        self.addLink( s5 , s9, bw=10, delay='100ms')
        self.addLink( s5 , s6, bw=10, delay='15ms')
        self.addLink( s6 , s7, bw=10, delay='10ms')
        self.addLink( s7 , s8, bw=10, delay='12ms')
        self.addLink( s8 , s9, bw=10, delay='13ms')
