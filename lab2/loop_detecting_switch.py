        ...
        if dst == ETHERNET_MULTICAST and ARP in header_list:
            ...
            if key in self.sw:
                ...
                if self.sw[key] != in_port:
                    self.logger.info("Loop detected! Dropping ARP request: dpid=%s, src=%s, dst_ip=%s, in_port=%s (previous port=%s)", 
                ...
                self.sw[key] = in_port
                self.logger.info("Recording ARP request: dpid=%s, src=%s, dst_ip=%s, in_port=%s", 
