...
def run_fat_tree():
    ...
    # Configure all switches to standalone mode and enable STP
    info("*** Configuring switches: standalone mode + STP ***\n")
    for switch in net.switches:
        ...
        info(f"  {switch.name}: standalone mode + STP enabled\n")
    
    # Wait for STP to converge (30 seconds)
    ...
    info("- STP: Enabled (prevents broadcast storms in loops)\n")
